...
export default function (existingCommand: ApplicationCommand, localCommand: ApplicationCommand) {
	const areChoicesDifferent = (existingChoices: any[string], localChoices: any) => {
